...
const DEFAULT_DESCRIPTION =
    "Спросите у Ассистента Веры про квоты, льготы и защиту от увольнения — ответ будет подготовлен на основе базы знаний, без регистрации.";
const DEFAULT_CTA_LABEL = "Спросить у Ассистента Веры";

/**
 * Баннер-приглашение в чат с Ассистентом Верой. Стиль — точная копия карточки
 * "Хотите узнать, как работает Ассистент Вера?" с /assistant (та же цветовая
